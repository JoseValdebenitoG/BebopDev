...
ventana = Tk()
ventana.title('myCalc')

i = 0

# Entrada
e_texto = Entry(ventana, font = ("Helvetica 20"))
e_texto.grid(row = 0, column = 0, columnspan = 4, padx = 11, pady = 5)
...
boton_sum = Button(ventana, text = "+", width = 4, height = 2, command = lambda: click_boton('+'))
boton_rest = Button(ventana, text = "-", width = 4, height = 2, command = lambda: click_boton('-'))
boton_igual = Button(ventana, text = "=", width = 4, height = 2, command = lambda: esIgual())

# Agregar botones en pantalla

boton_borrar.grid(row = 1, column = 0, padx = 2, pady = 2)
boton_parentesis1.grid(row = 1, column = 1, padx = 2, pady = 2)
...
boton_rest.grid(row = 3, column = 3, padx = 2, pady = 2)

boton1.grid(row = 4, column = 0, padx = 2, pady = 2)
boton2.grid(row = 4, column = 1, padx = 2, pady = 2)
boton3.grid(row = 4, column = 2, padx = 2, pady = 2)
boton_sum.grid(row = 4, column = 3, padx = 2, pady = 2)

boton0.grid(row = 5, column = 0, columnspan = 2, padx = 2, pady = 2)
